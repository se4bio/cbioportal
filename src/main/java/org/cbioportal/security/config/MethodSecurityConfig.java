...
@ConditionalOnExpression("{'oauth2','saml', 'saml_plus_basic', 'fake'}.contains('${authenticate}') or ('optional_oauth2' eq '${authenticate}' and 'true' eq '${security.method_authorization_enabled}')")
